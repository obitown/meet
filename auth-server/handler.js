 ...
 * update the calendar yourself. For more info, check out the SCOPES documentation at this 
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
     ...
     * The callback in this case is an arrow function with the results as parameters: “err” 
     * and “token.”
     */
